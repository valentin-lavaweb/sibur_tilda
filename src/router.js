...
const types_of_awards_page = () =>
  import("@/components/screen/types_of_awards_page.vue");
const team_track_winners = () =>
  import("@/components/screen/team_track_winners.vue");
...
const news_page = () => import("@/components/screen/news_page.vue");
const news_item = () => import("@/components/news_item.vue");
const admin_page = () => import("@/components/admin/admin_page.vue");

const command_awards = () =>
  import("@/components/admin/tables/command_awards.vue");
const personal_awards = () =>
  import("@/components/admin/tables/personal_awards.vue");
...
const routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: "command_awards_table",
        component: command_awards,
        name: "command_awards_table",
        meta: { requiresAuth: true },
      },
      {
        path: "personal_awards_table",
        component: personal_awards,
        name: "personal_awards_table",
        meta: { requiresAuth: true },
      },
      {
        path: "personal_award_sections_table",
        component: personal_award_sections,
        name: "personal_award_sections_table",
        meta: { requiresAuth: true },
      },
      {
        path: "gallery_table",
