  ...
  computed: {
    ...
    paginationButtons() {
      ...
      if (meta.last_page <= totalVisible) {
        ...
        [1, 2, meta.last_page, meta.last_page - 1].includes(meta.current_page)
      ) {
        // x,x,x,...,x,x,x
        ...
        [meta.last_page - 2, meta.last_page - 3].includes(meta.current_page)
      ) {
        // x,...,x,x,x,x,x
        for (let i = 1; i <= totalVisible; i += 1) {
          if (i === 1) {
    ...
    <div class="wrapper-block personal">
      ...
      <div class="block-changePage" v-if="meta">
        ...
        <div
          ...
          @click="nextPage"
          :class="{ disactive: this.page == this.meta.last_page }"
        >
          <img src="/img/arrow_page.svg" alt="arrow" />
        </div>
      </div>
