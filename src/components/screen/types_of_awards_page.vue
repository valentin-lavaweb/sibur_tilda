...
export default {
  ...
  data() {
    ...
    return {
      ...
      command_nomination_2025: [
        {
          nomination: "Лучшее отраслевое решение",
          description:
            "Проекты, направленные на улучшение клиентского опыта, развитие отношений с клиентами, разработку инновационных решений, направленных на удовлетворение потребностей клиентов.",
        },
        {
          nomination: "Вклад в развитие общества",
          description:
            "Проекты, направленные на расширение влияния СИБУРа на общество, развитие городов и регионов присутствия и в страны в целом.",
        },
        {
          nomination: "Люди в фокусе",
          description:
            "Проекты, направленные на развитие компетенций и профессионализма сотрудников, внедрение эффективных решений для удержания ценных специалистов и снижения текучести кадров, лидерство в области управления талантами, укрепления корпоративной культуры и повышения производительности через развитие и поддержку сотрудников.",
        },
        {
          nomination: "Перспективная инновация",
          description:
            "Проекты, направленные на совершенствование внутренних процессов компании, в том числе связанные с производственной системой, разработку и внедрение ИТ-решений (в том числе внедрение и использование новых технологий, напр., AI).",
        },
        {
          nomination: "Индустриальный импульс",
          description:
            "Проекты, направленные на увеличение производственных мощностей без риска снижения надежности оборудования; повышение надежности оборудования; расширение марочного ассортимента; повышение качества выпускаемой продукции; снижение потерь сырья и энергоресурсов; снижение потерь сырья и энергоресурсов; инфраструктурные проекты, направленные на строительство новых мощностей компании.",
        },
      ],
    };
  },
      ...
      <div class="nominationsContainer">
        ...
        <div class="nominationsBlock whiteBlock">
          ...
          <div class="nominations">
            <span
              class="nominationItem text-animate-gsap"
              v-for="(nomination, key) in command_nomination_2024"
              :key="nomination"
            >
              <div class="icon">
                <img :src="`/img/types_of_award/${key + 1}_3.svg`" alt="icon" />
        ...
        <div class="nominationsBlock whiteBlock">
          ...
          <div class="nominations">
            <span
              class="nominationItem text-animate-gsap"
              v-for="(nomination, key) in command_nomination_2022_2023"
              :key="nomination"
            >
              <div class="icon">
